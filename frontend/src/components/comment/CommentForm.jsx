...
export default function FormComment() {
    ...
    const loadMoreCommentBtn = (!isFinalComment && isHasComment) && (
        ...
        >
            {commentLoading && <svg aria-hidden="true" role="status" className="inline w-4 h-4 mr-3 text-sky-600 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="w-full md:w-full flex items-start md:w-full px-3">
                        ...
                        <div className="-mr-1">
                            ...
                            >
                                {postCommentLoading ? <Loading width="w-4" heigth="h-4" /> : "Post"}
                            </button>
                        </div>
                    </div>
                </div>
