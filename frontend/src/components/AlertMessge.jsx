...
export default function AlertMessage() {
    ...
    return (
        <div id="alert-border-3" class={`w-full h-12 absolute top-0 right-0 left-0 flex items-center p-4 mb-4 ${alert}`} role="alert">
            ...
            <button
                ...
                type="button"
                class={`ml-auto -mx-1.5 -my-1.5  rounded-lg focus:ring-2 p-1.5 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700 ${alertBtn}`} data-dismiss-target="#alert-border-3" aria-label="Close"
            >
