export default function CardPlaceholder({ isProfilePicture = true }) {
    return (
        <div role="status" className="max-w-sm p-4 shadow animate-pulse md:p-6">
            ...
            {isProfilePicture ? <div className="flex items-center mt-4 space-x-3">
