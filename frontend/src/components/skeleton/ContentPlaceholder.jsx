export default function ContentPlaceholder() {
    return (
        <div role="status" className="space-y-8 animate-pulse">
            ...
            <div className="h-5 bg-gray-300 rounded-full dark:bg-gray-700 w-full mb-1.5 mx-auto"></div>
            <div className="h-3.5 mx-auto bg-gray-300 rounded-full dark:bg-gray-700 w-full"></div>
            <div className="flex mt-4">
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="w-20 h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 my-3"></div>
